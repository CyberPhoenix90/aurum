...
import { ArrayDataSource, Aurum, AurumComponentAPI, DataSource, dsMap, getValueOf, Renderable } from 'aurumjs';
...
export function ProjectExplorer(props: ProjectExplorerProps, children: Renderable[], api: AurumComponentAPI) {
	return props.project.withInitial(undefined).transform(
		dsMap((project) => {
			...
			const entries: ArrayDataSource<TreeEntry<ProjectExplorerNode>> = project.content.map<TreeEntry<ProjectExplorerNode>>((e) =>
