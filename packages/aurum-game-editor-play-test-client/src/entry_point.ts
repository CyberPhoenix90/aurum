...
requirejs.config({
    paths: {
        ...
        ['aurum-game-editor-api']: 'node_modules/aurum-game-editor-api/prebuilt/amd/aurum-game-editor-api',
        ['aurum-game-engine']: 'node_modules/aurum-game-engine/prebuilt/amd/aurum-game-engine',
        ['aurum-layout-engine']: 'node_modules/aurum-layout-engine/prebuilt/amd/aurum-layout-engine',
