import { AurumComponentAPI, Renderable } from '@aurumjs/html';
...
export function TextField<T extends object = Record<string, string>>(props: TextFieldProps<T>, children: Renderable[], api: AurumComponentAPI): Renderable {
