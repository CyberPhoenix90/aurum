import { Aurum, AurumElementModel, CancellationToken, DataSource, dsMap, DuplexDataSource, Renderable } from 'aurumjs';
...
export function PanelContent(props: { style?: string }, children: ChildNode[]): Renderable {
	return undefined;
}
