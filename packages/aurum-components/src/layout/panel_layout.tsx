...
function generateStyle(props: PanelProps) {
	return aurumify([currentTheme], (theme, lifecycleToken) =>
		aurumify(
			[theme.fontFamily, theme.baseFontSize, theme.baseFontColor, theme.themeColor1, theme.themeColor3, theme.themeColor2],
			(fontFamily, size, fontColor, color1, color3, color2) => css`
