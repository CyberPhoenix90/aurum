declare module 'utilities/animation_scheduler' {
...
declare module 'stream/duplex_data_source' {
	...
	export class DuplexDataSource<T> implements GenericDataSource<T> {
		 ...
		 */
		static fromTwoDataSource<T>(
			downStream: DataSource<T>,
			upstream: DataSource<T>,
			initialValue?: T,
			propagateWritesToReadStream?: boolean
		): DuplexDataSource<T>;
		/**
...
declare module 'stream/stream' {
	...
	export class Stream<I, O = I> implements ReadOnlyDataSource<O> {
		...
		update(data: I): void;
		transform<A, B = A, C = B, D = C, E = D, F = E, G = F, H = G, Z = H, J = Z, K = J>(
...
declare module 'stream/data_source_operators' {
	...
	export function dsDiff<T>(): DataSourceMapOperator<
		T,
		{
			newValue: T;
			oldValue: T;
...
declare module 'nodes/dom_adapter' {
	...
	): (props: T, children: Renderable[], api: AurumComponentAPI) => HTMLElement;
...
declare module 'nodes/simple_dom_nodes' {
	...
	export const Address: (
		props: HTMLNodeProps<HTMLElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 * @internal
	 */
	 ...
	 */
	export const Area: (
		props: HTMLNodeProps<HTMLAreaElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Span: (
		props: HTMLNodeProps<HTMLSpanElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Ul: (
		props: HTMLNodeProps<HTMLUListElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Ol: (
		props: HTMLNodeProps<HTMLOListElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Tr: (
		props: HTMLNodeProps<HTMLTableRowElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Body: (
		props: HTMLNodeProps<HTMLBodyElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Title: (
		props: HTMLNodeProps<HTMLTitleElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	...
	export const Template: (
		props: HTMLNodeProps<HTMLTemplateElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const P: (
		props: HTMLNodeProps<HTMLParagraphElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	...
	export const Details: (
		props: HTMLNodeProps<HTMLDetailsElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Head: (
		props: HTMLNodeProps<HTMLHeadElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	...
	export const Heading: (
		props: HTMLNodeProps<HTMLHeadingElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Table: (
		props: HTMLNodeProps<HTMLTableElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Td: (
		props: HTMLNodeProps<HTMLTableColElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
	 ...
	 */
	export const Th: (
		props: HTMLNodeProps<HTMLTableHeaderCellElement>,
		children: import('aurumjs').Renderable[],
		api: import('aurumjs').AurumComponentAPI
	) => HTMLElement;
	/**
...
declare module 'builtin_compoents/switch' {
	...
	export function Switch<T = boolean>(
		props: SwitchProps<T>,
		children: Renderable[],
		api: AurumComponentAPI
	): import('stream/data_source').DataSource<Renderable[]>;
